...
namespace JwtAuthenticationManager
{
    public class JwtTokenHandler
    {
        ...
        private const int JWT_TOKEN_VALIDITY_MINS = 160;
        ...
        public AuthenticationResponse? GenerateJwtToken(AuthenticationRequest authenticationRequest, string CompanyFullName, string LoginType, int CompanyId)
        {
